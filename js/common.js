...
$("#field-d0516e405fd6973").val("Include local dialling code");
$("#field-5005caaa55968da").val("Format DDMMYYY");
$("#field-8e31290be8ffce6").val("The more you enter here, the less we have to check with you :)");
...
function changePosition() {
 ...
 function moveSlide() { $('#slidesHolder') 
